...
_PROMPT = """\
你是直播内容的「人物策划」。读完下面这位主播的设定，做两件事：
(1) 把他/她抽象成一个「有自己看法的活人」——不是复述设定，而是挖出能让人忍不住听下去的活人细节；
(2) 提炼这个人在这个话题上「凭什么值得听」的内容内核。
最重要的原则：**有意思不来自事情本身离奇——事要普通、接地气，普通到人人都经历过才可信；
有意思来自这个人对这件普通小事的【独特看法和洞察】**。好主播能把"帮朋友做决定"聊出
"你替他选=以后他失败都赖你"这种一听就"诶，对哦！"的歪理；事只是个由头，看法才是节目。
...
{{
  ...
  "story": {{
    "spine": "<主线：就讲【一件】普通、具体的小事，有具体的人/事/时间。事越平常越好（人人经历过才有代入），不是抽象感悟，也不要离奇情节>",
    "core_struggle": "<主角围绕这件事的【核心纠结/矛盾点】——他真正在意、犹豫、想不通或最想吐槽的那一个点。这是内容的心脏>",
    "twist": "<【认知翻转】：讲着讲着突然把这件普通小事看穿的那一下——一个观众没想过、但一听就'诶，对哦！'的洞察/歪理/精准观察。不需要剧情反转，视角一换就是翻转>",
    "central_contrast": "<这件事里'大家以为的'和'他看出来的'之间最大的反差>",
    "emotional_undercurrent": "<情绪暗线：从什么情绪走到什么情绪>",
    "story_beats": [
      "<起：用具体场景/物品/心情把人带进这件小事（铺，别急着给看法）>",
      "<...：纠结/矛盾升级，或者第一层看法（可有可无，看内容撑不撑得起）>",
      "<转：把事看穿的【那一下】——说出那个洞察/歪理，对应上面的 twist（必有）>",
      "<合：洞察落回生活，留个具体画面或一句自嘲，不要喊口号升华（必有）>"
    ],
    "punchline_seeds": ["<洞察种子，2-4个：把这件小事讲穿的歪理/观察/精准比喻，粗胚即可，编剧会再打磨>"],
    "hook_angle": "<开场前30-60秒怎么抓人，一句话>"
  }}
}}

要点：
- story_beats 是【同一件事】的几个阶段，围绕 core_struggle 推进；不是几件不同的事，
  也不是同一个点绕几遍。其中【转(twist)】是重头戏——但它是**认知上的翻转**（一句洞察把
  前面唠的小事看穿），不是剧情爆点，更不是空降高概念世界观。事平淡没关系，看法要锋利。
